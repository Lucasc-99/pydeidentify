from pydeidentify import Deidentifier, DeidentifiedText, replace_words_with_map

# The pipeline can only handle up to 512 tokens per string. Break up your text into chunks like so if necessary
text = [
    """
...
d = Deidentifier(
    ...
    classifier="dslim/bert-base-NER",
